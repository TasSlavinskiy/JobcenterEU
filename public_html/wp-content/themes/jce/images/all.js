...
$(function(){
    ...
    $('#close,.popup-overlay').on('click',function(e){
        e.preventDefault();
        var toClose = $(this).closest('.popup');
        $(toClose).fadeOut();
    });
    ...
    $('.menuAccordion').on('click',function(e){
        e.preventDefault();
    ...
    $('header .mainNav li.menu-item-has-children').on('click',function(){
